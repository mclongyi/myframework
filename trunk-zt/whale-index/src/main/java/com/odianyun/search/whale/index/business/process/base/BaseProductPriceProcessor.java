...
public abstract class BaseProductPriceProcessor implements Processor {

	public abstract void calcProductPrice(Map<Long,BusinessProduct> map,int companyId) throws Exception;

	@Override
	public String getName() {
		// TODO Auto-generated method stub
		return BaseProductPriceProcessor.class.getSimpleName();
	}
	...
	public void process(ProcessorContext processorContext) throws Exception {
		...
		if(map.size() > 0){
			calcProductPrice(map,processorContext.getCompanyId());
		}
	}
