package com.odianyun.search.whale.analysis.chinese;
...
public class ZHConverter {
	...
	static Logger log = Logger.getLogger(ZHConverter.class);
...
//	    URL url = getClass().getResource(propertyFile);
	...
	private void initializeHelper() {
		...
		Iterator<String> strIter = stringPossibilities.keySet().iterator();
