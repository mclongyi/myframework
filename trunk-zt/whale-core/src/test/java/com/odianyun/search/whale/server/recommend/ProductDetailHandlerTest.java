 ...
 */
public class ProductDetailHandlerTest extends AbstractTest{
    ...
    public static void  main(String[] args)throws Exception{
        ...
        RecommendRequest recommendRequest=new RecommendRequest(RecommendScene.PRODUCT_DETAIL);
        List<Long> mpIds=new ArrayList<Long>();
        mpIds.add(1049011601005458l);
        recommendRequest.setCurrentVisitMpIds(mpIds);
        recommendRequest.setUserId(344l);
