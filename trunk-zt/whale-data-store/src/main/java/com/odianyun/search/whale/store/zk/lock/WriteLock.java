 ...
 */
package com.odianyun.search.whale.store.zk.lock;
...
import com.odianyun.search.whale.store.zk.ZkClient;
...
public class WriteLock extends ProtocolSupport {
     ...
     */
    public WriteLock(ZkClient zkClient, String dir, List<ACL> acl) {
        super(zkClient);
        this.dir = dir;
        if (acl != null) {
            setAcl(acl);
            ...
            try {
                ...
                ZooKeeperOperation zopdel = new ZooKeeperOperation() {
                    public boolean execute() throws KeeperException,
                        ...
                        zkClient.getZooKeeper().delete(id, -1);   
                        LOG.info("delete path success, path:" + id);
                        return Boolean.TRUE;
                    }
                };
                zopdel.execute();
...
//                            Stat stat = zookeeper.exists(lastChildId, new LockWatcher());
                            Stat stat = zookeeper.exists(lastChildId, null);
                            if (stat != null) {
                            	LOG.info("get lock return false, path:" + id);
                            ...
                            if (isOwner()) {
                            	...
                            	LOG.info("get lock return true, path:" + id);
                                return Boolean.TRUE;
                            }
                        }
                    }
